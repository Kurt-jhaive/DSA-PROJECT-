...
class RegisterFrame(tk.Canvas):
    ...
    def hamburger_menu_clicked(self):
        ...
        self.breed_textbox.lower()
        self.gender_textbox.lower()
        self.size_textbox.lower()
        self.description_textbox.lower()  
    ...
    def close_hamburger_menu_clicked(self): 
        ...
        self.breed_textbox.lift()
        self.gender_textbox.lift()
        self.size_textbox.lift()
        self.description_textbox.lift()  
